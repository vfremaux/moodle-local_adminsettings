...
if ($hassiteconfig) {
    ...
    // PATCH : Activate debug for selected users
    $temp->add(new admin_setting_configtext('debugusers', new lang_string('debugusers', 'local_advancedperfs'), new lang_string('configdebugusers', 'local_advancedperfs'), ''));
    $temp->add(new admin_setting_configtext('debugfromips', new lang_string('debugfromips', 'local_advancedperfs'), new lang_string('configdebugfromips', 'local_advancedperfs'), ''));
    // /PATCH
